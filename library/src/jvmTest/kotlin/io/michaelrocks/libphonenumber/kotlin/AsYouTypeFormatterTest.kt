...
class AsYouTypeFormatterTest : TestMetadataTestCase() {
    ...
    fun testAYTFAndRememberPositionUS() {
        ...
        assertEquals(1, formatter.rememberedPosition)
        assertEquals("16", formatter.inputDigit('6'))
        assertEquals("1 65", formatter.inputDigit('5'))
        assertEquals(1, formatter.rememberedPosition)
        assertEquals("1 650", formatter.inputDigitAndRememberPosition('0'))
        assertEquals(5, formatter.rememberedPosition)
        assertEquals("1 650 2", formatter.inputDigit('2'))
        assertEquals("1 650 25", formatter.inputDigit('5'))
        ...
        assertEquals(8, formatter.rememberedPosition)
        assertEquals("650 253 22", formatter.inputDigit('2'))
        assertEquals(9, formatter.rememberedPosition)
        assertEquals("650 253 222", formatter.inputDigit('2'))
        // No more formatting when semicolon is entered.
        assertEquals("650253222;", formatter.inputDigit(';'))
        assertEquals(7, formatter.rememberedPosition)
        ...
        assertEquals("+1 65", formatter.inputDigit('5'))
        assertEquals("+1 650", formatter.inputDigit('0'))
        assertEquals(4, formatter.rememberedPosition)
        assertEquals("+1 650 2", formatter.inputDigit('2'))
        assertEquals(4, formatter.rememberedPosition)
        assertEquals("+1 650 25", formatter.inputDigit('5'))
    ...
    fun testAYTFClearNDDAfterIDDExtraction() {
        ...
        assertEquals("0", formatter.extractedNationalPrefix)
        ...
        assertEquals("", formatter.extractedNationalPrefix)
